...
class ImageValidatorTest extends PHPUnit_Framework_TestCase
{
        ...
        $this->check(
            [
                'bob'       => $this->fileFaker(
                    ...
                    20,
                    File::VALID_ERROR,
                    __DIR__.'/image/redstone.jpg'   // dimension => 48*48
                ),
            ],
            [
                'bob'       => [
    ...
    public function test_messages()
    {
        ...
        $this->assertTrue( $this->validator->fails() );
        $this->assertEquals(
            $this->validator->getErrorMessage( UPLOAD_ERR_PARTIAL ),
